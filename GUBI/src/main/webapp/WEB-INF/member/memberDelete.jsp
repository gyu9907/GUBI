...
<div class="container mt-5" style="border: solid 1px red;">
		...
		<div class="row" style="border: solid 1px gray; margin: 0 10px">
			<div class="col-lg-12 col-md-12">
				<p style="margin-top: 20px; font-size: 15pt; font-weight: bold;">
					1. 회원탈퇴 전, 유의사항을 확인해 주시기 바랍니다. <%-- ul 태그로 간격을 맞추자 --%>
				</p>
				<ol>
		...
		<div class="row" style="border: solid 1px #ccc; margin: 25px 10px;">
			...
			<div class="col-lg-12 col-md-12">
				<%-- <label  for="userid">아이디 : <input type="text" id="userid" value="userid" /></label> --%>
				<label class="labelMr" for="name">이름 : <input type="text" id="name" readonly class="underline disabled" value="이준영" /></label>
				<label class="labelMr" for="email">이메일 : <input type="email" id="email" readonly class="underline disabled" value="minjun9492@gmail.com" /></label>
				<label class="labelMr" for="passwd">비밀번호 : <input type="password" id="passwd" class="underline" /></label>
				<input type="button" id="btnSubmit" class="btnstyle" value="본인확인" onclick="gomemberDelete()" />
			</div>
			<div class="col-lg-12 col-md-12">
