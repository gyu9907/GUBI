...
@WebServlet(
		...
		urlPatterns = {"*.gu"},
		initParams = {
				@WebInitParam(name = "propertyConfig", value = "C:/git/GUBI/GUBI/src/main/webapp/WEB-INF/Command.properties", description = "*.up 에 대한 클래스의 매핑파일") 
	    })
...
//		System.out.println("확인용 props => " + props);
		...
		try {
			...
			// fls는 C:/NCS/workspace_jsp/MyMVC/src/main/webapp/WEB-INF/Command.properties 파일의 내용을 읽어오기 위한 객체이다.
	    ...
	    */
	        ...
	        */
			...
			while(en.hasMoreElements()) {
				...
				/*
				 	확인용 key => /text/test2.up
					확인용 value => text.controller.Test2Controller
					
					확인용 key => /text1.up
					확인용 value => text.controller.Test1Controller
					
					확인용 key => /text3.up
					확인용 value => text.controller.Test3Controller
				*/
