...
public class DeliveryRegisterPopup extends AbstractController {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if ("GET".equals(method)) {
            super.setRedirect(false);
            super.setViewPage("/WEB-INF/delivery/deliveryRegisterPopup.jsp");
        } else { // POST method
            ...
            try {
                ...
                if (n == 1) {
                    ...
                    loc = request.getContextPath() + "/deliveryListPopup.gu"; // 마이페이지로 이동
                } else {
